...
bool TsWriter::WriteDataStream(const std::shared_ptr<std::vector<uint8_t>> & data)
{
...
bool TsWriter::WritePMT()
{
	...
	if (_video_enable)
	{
		pmt_bit.Write(8, TS_STREAM_TYPE_AVC); 			// streaming_type
	...
	if (_audio_enable)
	{
		pmt_bit.Write(8, TS_STREAM_TYPE_ISO_IEC_13818_7);// streaming_type
		pmt_bit.Write(3, 0x7);                   		// reserved
...
//====================================================================================================
// Make PES header(Packetized Elementary Stream )
