...
// -  size \r\n data \r\n .......\r\n0\r\n\r\n
//====================================================================================================
const std::shared_ptr<std::vector<uint8_t>> M4sInitWriter::CreateData(bool http_chunked_transfer_support)
{
	auto data_stream = std::make_shared<std::vector<uint8_t>>();
	data_stream->reserve(4096);
	...
	if(http_chunked_transfer_support)
	{
		...
		data_stream->insert(data_stream->begin(), prefix.begin(), prefix.end());
		data_stream->insert(data_stream->end(), suffix.begin(), suffix.end());
	}
